const lang = {
  ...
  dashboard: 'DASHBOARD',
  dashboard_subtitle: 'Overview of your key metrics and recent activity',
  dashboard_subtitle_hr: 'HR overview: approvals, payroll, attendance and leave',
  dashboard_subtitle_finance: 'Finance overview: invoices, payments and revenue',
  dashboard_subtitle_employee: 'Your overview: approvals, leave and attendance',
  ...
  income: 'Income',
  outcome: 'Outcome',
  company_income_outcome: 'Company Income & Outcome',
  product: 'Product',
  inventory: 'INVENTORY',
  ...
  fiscal_period_list: 'Fiscal Period List',
  add_new_fiscal_period: 'Add New Fiscal Period',
  expense: 'Expense',
  ...
  import_payroll_help: 'Paste your salary sheet as CSV. First row must be headers. Columns: Name of Employees, Basic Salary, Taxable Allowance, Non-Taxable Allowance, Overtime, Penalty, Gross Salary, Taxable Income, 11% Pension (Company), 7% Pension (Employee), Loan, Income Tax, Total Deduction, Net Pay. Employee names must match existing employees in the system.',
  paste_csv_headers: 'Paste CSV (first row = headers)',
  month: 'Month',
